...
public abstract class ToStringStyle implements Serializable {
    ...
    /**
     * The short prefix without null field toString style. Using the
     * <code>Person</code> example from {@link ToStringBuilder}, the output
     * would look like this:
     * 
     * Person p = new Person();
     * 
     * <pre>
     * Person[age=0,smoker=false]
     * </pre>
     * 
     * 
     */
    public static final ToStringStyle SHORT_PREFIX_WITHOUT_NULL_FIELD_STYLE = new ShortPrefixWithoutNullToStringStyle();
    ...
    /**
     * Whether to print the null field, the default is <code>true</code>
     */
    private boolean printNullField = true;
    ...
    /**
     * Getter method for property <tt>printNullField</tt>.
     * 
     * @return property value of printNullField
     */
    public boolean isPrintNullField() {
	return printNullField;
    }

    /**
     * Setter method for property <tt>printNullField</tt>.
     * 
     * @param printNullField
     *            value to be assigned to property printNullField
     */
    public void setPrintNullField(boolean printNullField) {
	this.printNullField = printNullField;
    }
     ...
     * 
     * <p>
     * <code>TostringStyle</code> the prints almost like the
     * {@link ShortPrefixToStringStyle} but just ignore the null fields.
     * </p>
     * 
     */
    private static final class ShortPrefixWithoutNullToStringStyle extends
	    ToStringStyle {
	private static final long serialVersionUID = 1L;
	 ...
	 * </p>
	 */
	ShortPrefixWithoutNullToStringStyle() {
	    super();
	    this.setUseShortClassName(true);
	    this.setUseIdentityHashCode(false);
	    this.setPrintNullField(false);
	}
	 ...
	 */
	private Object readResolve() {
	    return ToStringStyle.SHORT_PREFIX_WITHOUT_NULL_FIELD_STYLE;
	}
    }
