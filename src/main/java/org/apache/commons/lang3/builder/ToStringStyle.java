...
public abstract class ToStringStyle implements Serializable {
    ...
    /**
     * The multi line toString style. Using the <code>Person</code> example from
     ...
     * @since 2.0
     */
    public void appendSuper(final StringBuffer buffer,
    ...
    public void appendToString(final StringBuffer buffer, final String toString) {
        if (toString != null) {
            final int pos1 = toString.indexOf(contentStart)
                    + contentStart.length();
     ...
     * @since 2.2
     */
    protected void appendCyclicObject(final StringBuffer buffer,
     ...
     *            <code>null</code>
     */
    protected void appendSummary(final StringBuffer buffer,
            final String fieldName, final Object value) {
     ...
     */
    protected void appendClassName(final StringBuffer buffer,
            final Object object) {
     ...
     */
    protected void appendIdentityHashCode(final StringBuffer buffer,
            final Object object) {
     ...
     *            the size to append
     */
    protected void appendSummarySize(final StringBuffer buffer,
