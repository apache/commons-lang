...
public abstract class Diff<T> extends Pair<T, T> {
     ...
     */
    @SuppressWarnings("array.access.unsafe.high.constant") //  Diff.class.getTypeParameters()[0]), a Type variable is declared, hence getTypeParameters() will not return an array of length 0
    protected Diff(final String fieldName) {
        this.type = ObjectUtils.defaultIfNull(
                TypeUtils.getTypeArguments(getClass(), Diff.class).get(
                        Diff.class.getTypeParameters()[0]), Object.class); // a Type variable is declared, hence getTypeParameters() will not return an array of length 0
