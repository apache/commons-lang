...
public class FastTimeZone {
     ...
     */
    @SuppressWarnings("argument.type.incompatible") // #1 m.matches() => the entire region sequence matches the pattern => m.group(1) will not return null and will return a @MinLen(1) String
