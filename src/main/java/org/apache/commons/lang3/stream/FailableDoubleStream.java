...
public class FailableDoubleStream extends FailableBaseStream<Double, FailableDoubleStream> {
     ...
     */
    public boolean allMatch(final FailableDoublePredicate<?> predicate) {
        makeTerminated();
        return doubleStream.allMatch(Functions.asDoublePredicate(predicate));
    }
     ...
     */
    public boolean anyMatch(final FailableDoublePredicate<?> predicate) {
        makeTerminated();
        return doubleStream.anyMatch(Functions.asDoublePredicate(predicate));
    }
     ...
     * provided predicate or the stream is empty, otherwise {@code false}
     */
    public boolean noneMatch(final FailableDoublePredicate<?> predicate) {
        makeTerminated();
        return doubleStream.noneMatch(Functions.asDoublePredicate(predicate));
    }
