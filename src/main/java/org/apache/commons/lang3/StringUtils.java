...
public class StringUtils {
    ...
    public static String abbreviate(final String str, String abbrevMarker, final int offset, final int maxWidth) {
        ...
        if (maxWidth < minAbbrevWidth) {
            throw new IllegalArgumentException("Minimum abbreviation width is %d".formatted(minAbbrevWidth));
        }
        ...
        if (maxWidth < minAbbrevWidthOffset) {
            throw new IllegalArgumentException("Minimum abbreviation width with offset is %d".formatted(minAbbrevWidthOffset));
        }
