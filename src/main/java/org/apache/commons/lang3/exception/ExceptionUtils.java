...
public class ExceptionUtils {
     ...
     *
     * @param throwable  the throwable to introspect for a cause, may be {@code null}
     ...
     * loop is returned.</p>
     *
     * @param throwable  the throwable to get the root cause for, may be {@code null}
     * @return the root cause of the {@link Throwable},
     *  {@code null} if {@code null} throwable input
     */
     ...
     *
     * @param throwable  the throwable to examine, may be {@code null}
     ...
     *
     * @param throwable  the {@link Throwable} to examine, may be {@code null}
    ...
    /**
     * Gets the stack trace from a Throwable as a {@link String}.
     *
     * <p>The result of this method vary by JDK version as this method
     * uses {@link Throwable#printStackTrace(java.io.PrintWriter)}.
     * On JDK1.3 and earlier, the cause exception will not be shown
     * unless the specified throwable alters printStackTrace.</p>
     *
     * @param throwable  the {@link Throwable} to be examined, may be {@code null}
     ...
     * @return the count of throwables, zero if {@code null} input
     */
     ...
     * that don't have nested causes.</p>
     *
     * @param throwable  the throwable to output, may be {@code null}
     ...
     *
     * @param <T> the type of {@link Throwable} you are searching.
     * @param throwable  the throwable to inspect, may be {@code null}
