 ...
 *
 * <p>
 * According to <a href="https://docs.oracle.com/javase/8/docs/api/java/nio/charset/Charset.html">JRE character
 * encoding names</a>:
 * </p>
 *
 * <p>
 * <cite>Every implementation of the Java platform is required to support the following character encodings.
