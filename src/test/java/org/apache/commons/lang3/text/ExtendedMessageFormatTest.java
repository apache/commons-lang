...
public class ExtendedMessageFormatTest extends AbstractLangTest {
    ...
    // String pattern = "Choice: {0,choice,1.0#{0} {1,lower} {2,number}|2.0#{0}
    // {1,upper} {2,number,currency}}";
    ...
    /**
     * Create an ExtendedMessageFormat for the specified pattern and locale and
     * check the
    ...
    /**
     * Replace MessageFormat(String, Locale) constructor (not available until JDK
     * 1.4).
     * 
     * @param pattern string
     * @param locale  Locale
    ...
    /**
     * Test Bug LANG-917 - IndexOutOfBoundsException and/or infinite loop when using
     * a choice pattern
     */
    @Test
    ...
    public void testEqualsHashcode() {
        final Map<String, ? extends FormatFactory> fmtRegistry = Collections.singletonMap("testfmt",
                new LowerCaseFormatFactory());
        final Map<String, ? extends FormatFactory> otherRegistry = Collections.singletonMap("testfmt",
                new UpperCaseFormatFactory());
    ...
    /**
     * Test Bug LANG-948 - Exception while using ExtendedMessageFormat and escaping
     * braces
     */
    @Test
    ...
    public void testOverriddenBuiltinFormat() {
        ...
        final Object[] args = { cal.getTime() };
        final Locale[] availableLocales = DateFormat.getAvailableLocales();
        final Map<String, ? extends FormatFactory> dateRegistry = Collections.singletonMap("date",
                new OverrideShortDateFormatFactory());
    ...
    public void testEqualsAndHashCode() {
        final String pattern = "Test {0,lower}";
        final ExtendedMessageFormat emf1 = new ExtendedMessageFormat(pattern, registry);
        final ExtendedMessageFormat emf2 = new ExtendedMessageFormat(pattern, registry);
        assertEquals(emf1, emf2);
        assertEquals(emf1.hashCode(), emf2.hashCode());
    }

    /**
     * Test UnsupportedOperationException for setFormat methods.
     */
    @Test
    public void testUnsupportedOperationException() {
        final String pattern = "Test {0,lower}";
        final ExtendedMessageFormat emf = new ExtendedMessageFormat(pattern, registry);
        assertThrows(UnsupportedOperationException.class, () -> emf.setFormat(0, null));
        assertThrows(UnsupportedOperationException.class, () -> emf.setFormatByArgumentIndex(0, null));
        assertThrows(UnsupportedOperationException.class, () -> emf.setFormats(new Format[0]));
        assertThrows(UnsupportedOperationException.class, () -> emf.setFormatsByArgumentIndex(new Format[0]));
    }
