...
/**
 * Tests the org.apache.commons.lang2.exception.NestableException class.
 *
...
public class NestableExceptionTestCase extends AbstractNestableTestCase {
    ...
    public void testSpecificPrintStackTrace()
    {
        ...
        assertTrue( "printStackTrace() starts with outer message", msg.startsWith("org.apache.commons.lang2.exception.NestableException: outer"));
        assertTrue( "printStackTrace() contains 1st nested message", msg.indexOf("Caused by: org.apache.commons.lang2.exception.NestableException: inner") >= 0);
        ...
        assertTrue( "printStackTrace() inner message after outer message", 
            msg.indexOf("org.apache.commons.lang2.exception.NestableException: outer") <
            msg.indexOf("Caused by: org.apache.commons.lang2.exception.NestableException: inner"));
