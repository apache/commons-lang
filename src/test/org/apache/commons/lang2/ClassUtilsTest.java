...
/**
 * Unit tests {@link org.apache.commons.lang2.ClassUtils}.
 *
...
public class ClassUtilsTest extends TestCase {
    ...
    public void test_getPackageName_Object() {
        assertEquals("org.apache.commons.lang2", ClassUtils.getPackageName(new ClassUtils(), "<null>"));
        assertEquals("org.apache.commons.lang2", ClassUtils.getPackageName(new Inner(), "<null>"));
    ...
    public void test_getPackageName_String() {
        assertEquals("org.apache.commons.lang2", ClassUtils.getPackageName(ClassUtils.class.getName()));
    ...
    public void testPrimitiveToWrapper() {
        ...
        assertEquals("ClassUtils.class -> ClassUtils.class",
            org.apache.commons.lang2.ClassUtils.class, 
            ClassUtils.primitiveToWrapper(org.apache.commons.lang2.ClassUtils.class));
